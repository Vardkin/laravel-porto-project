...
namespace LaravelPorto\Ship\Providers;
        ...
        $routeProviderListFunction = function () {
            ...
            foreach ($filesystem->directories(app_path('Containers')) as $directory) {
                ...
                if (file_exists($webRouteProvider)) {
                    $webProviderClass = 'LaravelPorto\Containers\\'.$uiModuleName.'\UI\WEB\Routes\RouteProvider';
                ...
                if (file_exists($apiRouteProvider)) {
                    $apiProviderClass = 'LaravelPorto\Containers\\'.$uiModuleName.'\UI\API\Routes\RouteProvider';
